...
def vigilancia():
    haar_upper_body_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/13405_18147_bundle_archive/haarcascade_upperbody.xml")
    haar_lower_body_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/13405_18147_bundle_archive/haarcascade_lowerbody.xml")
    haar_full_body_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/13405_18147_bundle_archive/haarcascade_fullbody.xml")
    haar_full_face_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/13405_18147_bundle_archive/haarcascade_frontalface_default.xml")
    haar_full_catface_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/13405_18147_bundle_archive/haarcascade_frontalcatface_extended.xml")
    #haar_full_cow_cascade = cv2.CascadeClassifier("C:/Users/crisd/Downloads/vaca.xml")
    ...
    while True:
       ...
       # rectList, weights = cv2.groupRectangles(np.array(upper_body).tolist(), 1, 0.2)
        ...
        for (x, y, w, h) in full_catface :
            ...
            cv2.putText(frame, "Animal Detected", (x + 5, y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
            cont=cont+1
            grupo=[grupo,verde4]
            now = datetime.now()
            nows = now.strftime("%d/%m/%Y %H:%M:%S")
